...
# pega os dataframes
df_g1_noticias_1733440362_1000 = pd.read_csv("g1_noticias_1733440362_1000.csv")
df_g1_noticias_1733448595_4000 = pd.read_csv("g1_noticias_1733448595_4000.csv")
df_g1_noticias_1733846320_6799 = pd.read_csv("g1_noticias_1733846320_6799.csv")
df_g1_noticias_1733861514_1882 = pd.read_csv("g1_noticias_1733861514_1882.csv")
...
# pega os dataframes
df_metropoles_noticias_1734043262_40 = pd.read_csv("metropoles_noticias_1734043262_40.csv")
df_metropoles_noticias_1734047504_23 = pd.read_csv("metropoles_noticias_1734047504_23.csv")
df_metropoles_noticias_1734050733_250 = pd.read_csv("metropoles_noticias_1734050733_250.csv")
df_metropoles_noticias_1734129289_977 = pd.read_csv("metropoles_noticias_1734129289_977.csv")

df_metropoles_noticias_1734194144_231 = pd.read_csv("metropoles_noticias_1734194144_231.csv")
df_metropoles_noticias_1734199815_2430 = pd.read_csv("metropoles_noticias_1734199815_2430.csv")
df_metropoles_noticias_1734218031_291 = pd.read_csv("metropoles_noticias_1734206983_71.csv")
df_metropoles_noticias_1734218031_291 = pd.read_csv("metropoles_noticias_1734218031_291.csv")
df_metropoles_noticias_1734222435_1669 = pd.read_csv("metropoles_noticias_1734222435_1669.csv")
df_metropoles_noticias_1734271653_832 = pd.read_csv("metropoles_noticias_1734271653_832.csv")
df_metropoles_noticias_1734295787_9985 = pd.read_csv("metropoles_noticias_1734295787_9985.csv")
...
df.drop(['title', 'description', 'link', 'content'], axis=1, inplace=True)

# termos referentes a origem são tags desconhecidas ao modelo
# [fonte]

df['text'] = df['text'].replace('g1', '[fonte]')

df['text'] = df['text'].replace('G1', '[fonte]')

df['text'] = df['text'].replace('metropoles', '[fonte]')
df['text'] = df['text'].replace('metrópoles', '[fonte]')
df['text'] = df['text'].replace('Metrópoles', '[fonte]')
df['text'] = df['text'].replace('Metropoles', '[fonte]')
